...
- [x] **FIX-02**: Any hallucination-check bug in `src/providers/hallucinationCheck.ts` exposed by the ported ambiguous-match tests (TEST-04) is fixed while preserving the documented "never throw" contract
