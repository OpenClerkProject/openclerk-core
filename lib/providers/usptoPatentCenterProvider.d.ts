 ...
 */
export declare class UsptoPatentCenterProvider extends EnterpriseCitationProvider {
    readonly id = "uspto-patent-center";
    readonly name = "USPTO Patent Center (TODO)";
    readonly description = "Not yet implemented. Intended to look up patent filings/prosecution history via USPTO Patent Center for the Non-patent Literature workflow.";
    readonly credentialFields: ProviderCredentialField[];
    protected verifyCredentials(): Promise<void>;
