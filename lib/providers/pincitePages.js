...
exports.reconstructFullPageNumber = reconstructFullPageNumber;
exports.expandPincitePages = expandPincitePages;
/**
 ...
 */
function reconstructFullPageNumber(start, writtenEnd) {
 ...
 * it refers to.
 */
function expandPincitePages(pincite) {
    const pages = new Set();
