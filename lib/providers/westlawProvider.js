...
exports.WestlawProvider = void 0;
...
class WestlawProvider extends base_1.EnterpriseCitationProvider {
    constructor() {
        super(...arguments);
        this.id = "westlaw";
        this.name = "Westlaw";
        this.description = "Looks up citations through your organization's Westlaw / Thomson Reuters API subscription. Requires the API base URL and client credentials issued under your firm's Westlaw contract.";
...
exports.WestlawProvider = WestlawProvider;
