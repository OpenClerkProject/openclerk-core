...
export declare function supportsOpinionText(provider: CitationProvider): provider is OpinionTextCapableProvider;
/**
...
export declare function supportsRateLimitAwareness(provider: CitationProvider): provider is RateLimitAwareProvider;
