...
exports.checkPincitePageRange = checkPincitePageRange;
const pincitePages_1 = require("../providers/pincitePages");
/**
 ...
 */
function minimalDroppedForm(start, fullEnd) {
 ...
 */
function checkPincitePageRange(citation) {
    ...
    for (const segment of segments) {
        ...
        const fullEnd = (0, pincitePages_1.reconstructFullPageNumber)(start, writtenEnd);
