 ...
 */
export declare const MANUAL_REPORTER_CORRECTIONS: ManualReporterCorrection[];
/**
 ...
 */
export declare const MANUAL_VALID_REPORTER_FORMS: ManualValidReporterForm[];
/**
 ...
 */
export declare const MANUAL_CASE_NAME_ABBREVIATIONS: ManualCaseNameAbbreviation[];
