...
exports.applyManualReporterOverrides = applyManualReporterOverrides;
exports.buildReporterSpacingLookup = buildReporterSpacingLookup;
exports.checkReporterAbbreviation = checkReporterAbbreviation;
const reporterAbbreviations_generated_1 = require("./generated/reporterAbbreviations.generated");
 ...
 */
function applyManualReporterOverrides(generated, manualCorrections, manualValidForms) {
...
const { validForms, corrections } = applyManualReporterOverrides(reporterAbbreviations_generated_1.REPORTER_ABBREVIATIONS, manualCorrections_1.MANUAL_REPORTER_CORRECTIONS, manualCorrections_1.MANUAL_VALID_REPORTER_FORMS);
/**
 ...
 */
function buildReporterSpacingLookup(forms) {
    const strippedToForm = {};
 ...
 */
function checkReporterAbbreviation(citation) {
